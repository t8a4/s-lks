            ...
            if (data.nav && !isInit){
                ...
                $("#"+divId+" .slides-toolbar").append(
                    $("<img></img>").attr({
                        ...
                        "class":"slides-nav",
                        "alt":"Next Slide",
                        "src": "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><polyline points='9,4 17,12 9,20' stroke='white' stroke-width='3' fill='none' stroke-linecap='round' stroke-linejoin='round'/></svg>",
